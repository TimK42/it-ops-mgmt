...
echo ""
echo ">>> Mocha Unit Tests (Issue #94, #107, #117, #121-123, #134, #137, #138, #143, #144)"
MOCHA_OUTPUT=$(npx mocha tests/test-issue94-search.js tests/test-issue107-chips.js tests/test-issue117-export.js tests/test-issue121-123-archive-button.js tests/test-issue134-unarchive.js tests/test-issue137-pwa.js tests/test-issue138.js tests/test-issue143.js --timeout 15000 2>&1)
MOCHA_EXIT=$?
echo "$MOCHA_OUTPUT"
