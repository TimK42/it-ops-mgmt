...
- **Counter-intuitive concern**: The "sun in dark mode" meaning "switch to light" is actually correct — it shows the _next state_, not the _current state_. This is standard UI convention (e.g., YouTube's dark mode toggle, VS Code's theme switch).
