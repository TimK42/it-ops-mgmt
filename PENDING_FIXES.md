...
- **Mobile horizontal overflow (Users table):** `.table-container` now uses `overflow-x: auto` instead of `overflow: hidden` on mobile, allowing horizontal scrolling without cutting off content.
